...
class ClLike(Likelihood):
    ...
    def _get_jeffrey_bias_dchi2(self):
        ...
        dch2_jeffrey = self.provider._get_jeffrey_bias_dchi2_in_theory_class(self.data_vec,self.inv_conv)
    ...
    def _get_chi2(self, **pars):
        ...
        chi2 = self.provider.get_chi2()
        #print('o qui')
        dchi2_jeffrey = 0
        #if self.jeffrey_bias:
        #    dchi2_jeffrey = self.provider.get_jeffrey_bias_dchi2(self.inv_cov)
