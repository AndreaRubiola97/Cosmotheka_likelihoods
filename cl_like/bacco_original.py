    ...
    def update_pk(self, cosmo, bcmpar=None, **kwargs):
        ...
        if len(without_bounds_mpk) == 0: # if all parameters are within baccoemu narrower bounds, run Carlos' code.
            ...
            for par_name in without_bounds_mpk:  
                ...
                drk_dvariable_dictionary['drk_d' + par_name]  = self.central_derivator(self._get_drk_dparameter,to_start_value_mpk[par_name],dx=self.dx,args=(k_at_start,cosmopars_start_mpk.copy(),par_name))#[1]
